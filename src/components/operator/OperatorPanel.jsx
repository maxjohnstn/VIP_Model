    ...
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-brand-bg border-l border-white/10 overflow-y-auto">
        ...
        <div className="px-5 py-4 flex flex-col gap-6 pb-10">
          {/* Live metrics */}
          <div>
            <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Live Readings</h3>
            <LiveMetrics
          ...
          {todayPrediction && (
            <div className="bg-surface rounded-2xl p-4 border border-white/5">
              <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Forecast Accuracy</h3>
              <div className="flex gap-4">
                <div>
                  <p className="text-xs text-slate-500">Predicted full charge</p>
                  <p className="text-lg font-bold text-white">
                    {todayPrediction.predicted_full_charge_time ?? 'N/A'}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-slate-500">Actual full charge</p>
                  <p className="text-lg font-bold text-brand-green">
                    {todayPrediction.actual_full_charge_time ?? '—'}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-slate-500">Daily GTI</p>
                  <p className="text-lg font-bold text-brand-amber">
                    {todayPrediction.daily_gti_kwh} kWh
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* SOC Chart */}
          <div>
            <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Today's SOC Curve</h3>
          ...
          {/* Technical alerts */}
          <div>
            <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Technical Alerts</h3>
            <TechnicalAlerts hourlyRows={todayHourly} site={site} selectedDate={selectedDate} />
          </div>
        </div>
      </div>
    </>
